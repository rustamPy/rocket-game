    ...
    return (
        <div className="flex mb-20">
            <div className="flex gap-8">
                {/* Games */}
                <Popover>
                    <PopoverButton data-open className="text-sm/6 font-semibold text-black/50 focus:outline-none data-[active]:text-black data-[hover]:text-black data-[focus]:outline-1 data-[focus]:outline-black">
                        Games
                    </PopoverButton>
                    <Transition
